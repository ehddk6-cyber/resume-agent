...
# DATA
{
  ...
  "extra": {
      ...
      "question_strategies": [
        {
          ...
          "required_evidence": [
            "업무 효율 30% 증가",
            "서울시청 파견 근무 경험",
            "질문 기대: 성장과 학습 루프 문항이며, 질문 키워드(본인의, 발전을, 위해)와 가장 직접적으로 맞닿아 있습니다.\n이 경험의 강점: 정량 근거(업무 효율 30% 증가) / 면접에서 다시 꺼낼 증빙 문장 보유 / 개인 기여를 분리해 설명 가능.\n면접관 꼬리질문: 왜 다른 경험보다 이 사례가 직무 적합성을 잘 증명하는지를 30초 안에 방어할 준비가 필요합니다."
          ],
        ...
        },
        {
          ...
          "required_evidence": [
            ...
            "국민연금공단 인턴 근무 경험",
            "질문 기대: 상황판단과 우선순위 문항이며, 질문 키워드(판단이, 쉽지, 않은)와 가장 직접적으로 맞닿아 있습니다.\n이 경험의 강점: 정량 근거(3,000페이지 2일 완수, 목표 150건 초과 달성) / 면접에서 다시 꺼낼 증빙 문장 보유 / 개인 기여를 분리해 설명 가능.\n면접관 꼬리질문: 왜 다른 경험보다 이 사례가 직무 적합성을 잘 증명하는지를 30초 안에 방어할 준비가 필요합니다."
          ],
          "recommended_structure": [
            "상황/과제 1문장",
            "개인 판단과 행동 2문장",
        ...
        },
        {
          ...
          "required_evidence": [
            ...
            "서울시청 파견 근무 경험",
            "질문 기대: 원칙과 신뢰 문항이며, 질문 키워드(조직이나, 팀에서, 맡은)와 가장 직접적으로 맞닿아 있습니다.\n이 경험의 강점: 정량 근거(부정수급 20건 적발, 예산 40% 절감) / 면접에서 다시 꺼낼 증빙 문장 보유 / 개인 기여를 분리해 설명 가능.\n면접관 꼬리질문: 왜 다른 경험보다 이 사례가 직무 적합성을 잘 증명하는지를 30초 안에 방어할 준비가 필요합니다."
          ],
          "recommended_structure": [
            "상황/과제 1문장",
            "개인 판단과 행동 2문장",
        ...
        },
        {
          ...
          "required_evidence": [
            "수백 통 민원 당일 수습",
            "서울시청 파견 근무 경험",
            "질문 기대: 원칙과 신뢰 문항이며, 질문 키워드(농협의, 구성원으로서, 본인이)와 가장 직접적으로 맞닿아 있습니다.\n이 경험의 강점: 정량 근거(수백 통 민원 당일 수습) / 면접에서 다시 꺼낼 증빙 문장 보유 / 개인 기여를 분리해 설명 가능.\n면접관 꼬리질문: 왜 다른 경험보다 이 사례가 직무 적합성을 잘 증명하는지를 30초 안에 방어할 준비가 필요합니다."
          ],
          "recommended_structure": [
            "상황/과제 1문장",
            "개인 판단과 행동 2문장",
        ...
        },
        {
          ...
          "required_evidence": [
            "디지털 취약 계층 응대 성공",
            "새마을금고 아르바이트 경험",
            "질문 기대: 입사 후 기여 문항이며, 질문 키워드(농협이, 교육지원, 경제)와 가장 직접적으로 맞닿아 있습니다.\n이 경험의 강점: 정량 근거(디지털 취약 계층 응대 성공) / 면접에서 다시 꺼낼 증빙 문장 보유 / 개인 기여를 분리해 설명 가능.\n면접관 꼬리질문: 왜 다른 경험보다 이 사례가 직무 적합성을 잘 증명하는지를 30초 안에 방어할 준비가 필요합니다."
          ],
          "recommended_structure": [
            "상황/과제 1문장",
            "개인 판단과 행동 2문장",
    ...
    "feedback_learning": {
      ...
      "current_pattern": "writer|협동조합|TYPE_D-TYPE_E-TYPE_F-TYPE_I",
    ...
    "outcome_dashboard": {
      "generated_at": "2026-04-06T06:38:44.083350+00:00",
      "artifact_type": "writer",
      "current_pattern": "writer|협동조합|TYPE_D-TYPE_E-TYPE_F-TYPE_I",
      "overall_success_rate": 0.0,
      "outcome_summary": {
    ...
    "kpi_dashboard": {
      "generated_at": "2026-04-06T06:38:44.084795+00:00",
      "artifact_type": "writer",
    ...
    "application_strategy": {
      ...
      "job_title": "신규직원",
      "company_type": "협동조합",
      "updated_at": "2026-04-06T06:38:44.078968+00:00",
      "experience_priority": [
        {
          "experience_id": "exp_seoul_covid_fraud",
          "title": "서울시청 코로나19 지원팀 부정수급 적발",

...
# DATA
{
  ...
  "experiences": [
    ...
    {
      "id": "exp_banpo_event",
      "title": "반포한강공원 안내센터 행사 운영 디지털화 및 갈등 중재",
      "organization": "반포한강공원 안내센터",
      "period_start": "2019-01-01",
      "period_end": "2019-12-31",
      "situation": "대학교 천문동아리 연합 별보기 행사에서 수기 출석부 누락과 물품 혼선으로 2시간 지연이 발생했고, 공익·한강 지킴이·행정공무원·보안관 사이 직렬 갈등이 생김.",
      "task": "행사 운영을 디지털화하고 복합 조직 내 갈등을 중재해 정상 협업 체계를 회복",
      "action": "구글 폼과 스프레드시트로 사전 예약·만족도 조사·물품 관리를 디지털화하고, 구글 캘린더로 실시간 일정을 공유. 직책별 업무 범위와 책임을 정리한 자료를 배포하고 주기적 회의와 개별 면담으로 갈등을 조율함.",
      "result": "시간·인력 소모 50% 절약, 오류율 90% 감소, 자원봉사자 만족도 80% 이상 상승. 조직 내 갈등이 완화되고 협업 체계가 정상화됨.",
      "personal_contribution": "행사 프로세스 디지털화 설계, 역할 정의 자료 작성, 이해관계자 조율",
      "metrics": "시간·인력 50% 절약, 오류 90% 감소, 만족도 80% 이상 상승",
      "evidence_text": "반포한강공원 안내센터 파견 및 행사 운영 경험",
      "evidence_level": "L2",
      "tags": [
        "프로세스개선",
        "디지털화",
  ...
  "extra": {
    ...
    "feedback_learning": {
      ...
      "top_patterns": [],
      "recommended_pattern": "coach|협동조합|TYPE_D-TYPE_E-TYPE_F-TYPE_I",
      "current_pattern": "coach|협동조합|TYPE_D-TYPE_E-TYPE_F-TYPE_I",
    ...
    "self_intro_pack": {
      "opening_hook": "농·축협의 신규직원에서 정량적 성과, 문제 해결, 협업 성과, 기술능력를 만드는 지원자입니다.",
      "thirty_second_frame": [
    ...
    "narrative_ssot": {
      ...
      "opening_message": "농·축협의 신규직원에서 정량적 성과, 문제 해결, 협업 성과, 기술능력를 만드는 지원자입니다.",
      "risk_watchouts": [],
    ...
    "outcome_dashboard": {
      "generated_at": "2026-04-06T06:38:43.599848+00:00",
      "artifact_type": "coach",
      "current_pattern": "coach|협동조합|TYPE_D-TYPE_E-TYPE_F-TYPE_I",
      "overall_success_rate": 0.0,
      "outcome_summary": {
    ...
    "company_analysis": {
      ...
      "role_industry_strategy": {
        ...
        "tone_rules": [
          ...
          "신규직원 직무에서 바로 쓰일 행동/성과 중심으로 정리합니다."
        ],
        "banned_patterns": [
          "검증 불가 수치 확대",
          "회사 정보 복붙형 지원동기",

  ...
  "extra": {
    ...
    "coach_allocations": [
      ...
      },
      {
        ...
        "score": 16,
        "reason": "질문 기대: 실패와 복기 문항이며, 질문 키워드(높은, 목표를, 설정하여)와 가장 직접적으로 맞닿아 있습니다.\n이 경험의 강점: 정량 근거(1억 원 예산 절감) / 면접에서 다시 꺼낼 증빙 문장 보유 / 개인 기여를 분리해 설명 가능.\n면접관 꼬리질문: 왜 다른 경험보다 이 사례가 직무 적합성을 잘 증명하는지를 30초 안에 방어할 준비가 필요합니다.",
        "reuse_reason": null
      }
    ],
    "feedback_learning": {
      ...
      "top_patterns": [],
      "recommended_pattern": "coach|상호금융|TYPE_A-TYPE_G-TYPE_UNKNOWN",
      "current_pattern": "coach|상호금융|TYPE_A-TYPE_G-TYPE_UNKNOWN",
    ...
    "outcome_dashboard": {
      "generated_at": "2026-04-06T06:37:41.921415+00:00",
      "artifact_type": "coach",
      "current_pattern": "coach|상호금융|TYPE_A-TYPE_G-TYPE_UNKNOWN",
      "overall_success_rate": 0.0,
      "outcome_summary": {
    ...
    "kpi_dashboard": {
      "generated_at": "2026-04-06T06:37:41.922937+00:00",
      "artifact_type": "coach",

"""interactive.py 커버리지 — 누락 라인 87-88, 95, 97, 99, 101, 104-107, 111-158, 253-259, 274-275, 285-286, 296-297, 307-308, 327-388, 410, 417-421, 484, 569-702, 770-785, 811-818, 863-864, 876, 882, 886, 929-968, 973-982, 993-1004, 1014, 1022-1041, 1045-1087"""
...
class TestInteractiveCoachApplySuggestion:
    """InteractiveCoach._apply_suggestion 테스트 — 라인 261-323"""
...
class TestInteractiveCoachSelectExperience:
    """InteractiveCoach._select_experience 테스트 — 라인 390-421"""
...
class TestMockInterviewCoachProvideFeedback:
    """MockInterviewCoach._provide_feedback 테스트 — 라인 811-818"""
...
class TestMockInterviewCoachBuildReactionChain:
    """MockInterviewCoach._build_reaction_chain 테스트 — 라인 863-864"""
...
class TestMockInterviewCoachDeterminePressureLevel:
    """MockInterviewCoach._determine_pressure_level 테스트 — 라인 876, 882, 886"""
...
class TestMockInterviewCoachSelectCommitteePersona:
    """MockInterviewCoach._select_committee_persona 테스트 — 라인 929-968"""
...
class TestMockInterviewCoachSelectPanelPersonas:
    """MockInterviewCoach._select_panel_personas 테스트 — 라인 973-982"""
...
class TestMockInterviewCoachSelectFollowUpQuestion:
    """MockInterviewCoach._select_follow_up_question 테스트 — 라인 993-1004"""
...
class TestMockInterviewCoachRunCommitteeRounds:
    """MockInterviewCoach._run_committee_rounds 테스트 — 라인 1014, 1022-1041"""
...
class TestMockInterviewCoachSummarizeCommitteeRounds:
    """MockInterviewCoach._summarize_committee_rounds 테스트 — 라인 1045-1087"""

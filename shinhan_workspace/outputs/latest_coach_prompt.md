...
# DATA
{
  ...
  "experiences": [
    ...
    {
      "id": "exp_gangbuk_culture",
      "title": "강북문화재단 용역비 지급 서류 검토 및 예산 프로세스 이해",
      "organization": "강북문화재단 (강북구청 겨울방학 아르바이트)",
      "period_start": "2019-01-01",
      "period_end": "2019-02-28",
      "situation": "지역 문화 단체의 용역비 지급을 위한 서류(활동 내역, 지급 대상, 산출 내역, 지출 결의서 등) 검토 업무와 시의회 회의록 작성 업무를 동시에 수행해야 하는 상황.",
      "task": "용역비 지급 서류의 정확성을 검토하고, 공공기관 예산 지원 프로세스를 이해하며 체계적으로 업무 수행",
      "action": "체크리스트를 활용하여 서류 누락과 오류를 사전에 방지. 시간 관리로 두 가지 업무를 병행 수행. 오류 발생 시 원인을 분석하고 재발 방지 방안 적용.",
      "result": "행정 업무 정확성 증진. 공공기관 예산 지원 프로세스와 행정 체계를 깊이 이해하게 됨.",
      "personal_contribution": "체크리스트 설계, 이중 업무 시간 관리, 오류 분석·개선",
      "metrics": "체크리스트 기반 정확한 서류 처리",
      "evidence_text": "강북구청 겨울방학 아르바이트 경험",
      "evidence_level": "L2",
      "tags": [
        "서류검토",
        "꼼꼼함",
    ...
    {
      "id": "exp_capstone_market",
      "title": "제기동 약령시장 활성화 프로젝트 (캡스톤 디자인)",
      "organization": "한국외국어대학교 + 동대문구청 협업",
      "period_start": "2018-09-01",
      "period_end": "2018-12-31",
      "situation": "국내 한약재 유통의 70%를 차지하는 전통시장이 시장 낙후화·원산지/가격 불신으로 젊은 세대 방문객이 급감. 팀원 중 한 명이 가족 문제로 이탈 위기.",
      "task": "시장 활성화 및 브랜딩 전략을 기획하고, 이탈하려는 팀원을 다시 참여시키기",
      "action": "상인 50명 심층 인터뷰 및 타 시장 5곳 벤치마킹 수행. SNS 홍보·인플루언서 협업·국산 한약재 인증 마크·페스티벌·환경 개선(가격 명시화)·온라인 판매·배송 강화·'제기 야시장' 개설(15억 예산 추정, 청년 일자리 창출 연계)·약리단길 투어 등 종합 전략 기획. 이탈 위기 팀원과 개별 면담 후 역할 재분배하여 참여 유도.",
      "result": "데이터 기반 타겟 마케팅 및 오프라인 공간 활성화 기획안 도출. 팀원 유지 성공.",
      "personal_contribution": "시장 조사 설계·수행, 인터뷰, 전략 기획, 팀워크 관리",
      "metrics": "상인 50명 인터뷰, 타 시장 5곳 벤치마킹",
      "evidence_text": "졸업과제 캡스톤 디자인 프로젝트",
      "evidence_level": "L2",
      "tags": [
        "시장조사",
        "인터뷰",
    ...
    {
      "id": "exp_banpo_event",
      "title": "반포한강공원 행사 운영 디지털화 및 다중 조직 갈등 중재",
      "organization": "반포한강공원 안내센터 (대학교 천문동아리 연합 행사)",
      "period_start": "2019-06-01",
      "period_end": "2019-06-30",
      "situation": "대학교 천문동아리 연합 별보기 행사(100여 명)에서 수기 출석부 누락과 물품 혼선으로 2시간 지연 발생. 공익, 한강 지킴이(어르신), 행정공무원, 보안관 간 직렬 갈등 발생.",
      "task": "행사 운영을 디지털화하고, 복합 조직 내 갈등을 중재하여 협업 체계를 구축",
      "action": "(1) 수기 방식 폐지, 구글 폼/스프레드시트로 사전 예약·만족도 조사 디지털화. 구글 캘린더 연동 실시간 일정 안내, 물품 관리 수식 자동화 (2) 직책별 업무 범위·책임을 명확히 정리한 자료를 배포. 주기적 회의·티타임 추진. 개별 면담을 통한 중재.",
      "result": "시간·인력 소모 50% 절약, 오류율 90% 감소, 자원봉사자 만족도 80% 이상 상승. 조직 내 갈등 해소 및 정상 협업 체계 구축.",
      "personal_contribution": "디지털 전환 설계·도입, 조직 갈등 분석·중재, 협업 체계 수립",
      "metrics": "시간/인력 50% 절약, 오류 90% 감소, 만족도 80%+",
      "evidence_text": "반포한강공원 안내센터 파견 경험",
      "evidence_level": "L2",
      "tags": [
        "프로세스디지털화",
        "행사운영",
    ...
    {
      "id": "exp_finance_school",
      "title": "금융사관학교 금융 실무 교육 및 팀 리더십",
      "organization": "금융사관학교",
      "period_start": "2022-08-01",
      "period_end": "2022-11-30",
      "situation": "자산/개인금융 관리, 기업금융 컨설팅, 국제경제전문가 과정을 수료하는 금융 실무 교육 프로그램 참여. 블로그 후기 작성 조장 활동 병행.",
      "task": "금융 실무 역량을 쌓고, 팀원들의 블로그 후기 작성을 독려·관리하는 조장 역할 수행",
      "action": "금융 상품 분석, 자산관리 기법, 기업금융 컨설팅 실습에 적극 참여. 조장으로서 팀원별 블로그 후기 작성 일정 관리, 피드백 제공, 완료율 제고를 위한 독려.",
      "result": "3개 과정(자산/개인금융, 기업금융, 국제경제) 수료. 조원 전원 블로그 후기 작성 완료.",
      "personal_contribution": "금융 실무 학습, 팀 일정 관리, 피드백 제공, 완료율 관리",
      "metrics": "3개 과정 수료, 조원 전원 후기 작성 완료",
      "evidence_text": "금융사관학교 수료증",
      "evidence_level": "L2",
      "tags": [
        "금융지식",
        "리더십",
  ...
  "extra": {
    ...
    "feedback_learning": {
      ...
      "top_patterns": [],
      "recommended_pattern": "coach|금융|TYPE_B-TYPE_D-TYPE_UNKNOWN",
      "current_pattern": "coach|금융|TYPE_B-TYPE_D-TYPE_UNKNOWN",
    ...
    "self_intro_pack": {
      "opening_hook": "신한은행의 일반직 신입행원 (개인/기업금융)에서 매출/효율, 프로젝트 성과, 조직 기여, 기술능력를 만드는 지원자입니다.",
      "thirty_second_frame": [
    ...
    "narrative_ssot": {
      ...
      "opening_message": "신한은행의 일반직 신입행원 (개인/기업금융)에서 매출/효율, 프로젝트 성과, 조직 기여, 기술능력를 만드는 지원자입니다.",
      "risk_watchouts": [],
    ...
    "research_strategy_translation": {
      ...
      "top001": {
        ...
        "question_hooks": {
          "q1_strength": [
            "'매출/효율' 역량을 증명하는 경험은 다음과 같습니다",
            "구체적 사례를 들어 '매출/효율'를 설명드리겠습니다"
          ],
          "q2_value_conflict": [
            "구체적인 경험을 말씀드리겠습니다",
            "핵심만 간략히 설명드리겠습니다"
        ...
        "evidence_maps": [
          {
            "experience_id": "exp_seoul_covid_fraud",
            "signals": [
              "귀사에서 중시하는매출/효율 관련 경험",
              "귀사에서 중시하는프로젝트 성과 관련 경험"
            ],
            "proof_points": [
    ...
    "outcome_dashboard": {
      "generated_at": "2026-04-06T06:40:16.198394+00:00",
      "artifact_type": "coach",
      "current_pattern": "coach|금융|TYPE_B-TYPE_D-TYPE_UNKNOWN",
      "overall_success_rate": 0,
      "outcome_summary": {
    ...
    "kpi_dashboard": {
      "generated_at": "2026-04-06T06:40:16.199229+00:00",
      "artifact_type": "coach",
    ...
    "company_analysis": {
      ...
      "tone_guide": "구조화되고 체계적인 표현. 조직 적합성 강조. 안정성과 성장 가능성 균형.",
      "role_industry_strategy": {
        "target_role": "일반직 신입행원 (개인/기업금융)",
        "target_industry": "금융",
        "company_type": "대기업",
        "question_types": [],
        "writer_focus": [
        ...
        "tone_rules": [
          "구조화되고 체계적인 표현. 조직 적합성 강조. 안정성과 성장 가능성 균형.",
          "금융 산업 맥락을 과장 없이 연결합니다.",
          "일반직 신입행원 (개인/기업금융) 직무에서 바로 쓰일 행동/성과 중심으로 정리합니다."
        ],
        "banned_patterns": [
          "검증 불가 수치 확대",
          "회사 정보 복붙형 지원동기",
        ...
        "committee_personas": [
          ...
          },
          {
            "id": "domain",
            "name": "실무위원",
            "role": "일반직 신입행원 (개인/기업금융) 실무 적합성 검증",
            "focus": [
              "수치 검증",
              "개인 기여 검증",
              "대안 비교"
      ...
      "success_case_stats": {
        ...
        "customer_focus_rate": 0.7,
        "problem_solving_rate": 1.0,
        "collaboration_rate": 0.95,
